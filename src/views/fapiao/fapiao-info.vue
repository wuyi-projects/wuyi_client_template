        ...
        <el-col style="margin:0 auto;float: left;">
          ...
          <el-row>
            ...
            <div style="padding:0 40px;font-size:14px;">
              ...
              <el-row style="height:30px;">
                <el-col :span="8">
                  <span style="font-weight:bold;">购买方开户行及账号</span>{{ currentBilleInfo.purchaserDepositBank }}
                </el-col>
                <el-col :span="8">
...
import { getFapiao4Me } from '@/api/fapiao-management'
        ...
        getFapiao4Me({
          ...
          .then(response => {
            ...
            if (data) {
              ...
              this.currentBillUrlString = data.voucherUrl
            }
          })
          .catch(e => {
            that.loading = false
