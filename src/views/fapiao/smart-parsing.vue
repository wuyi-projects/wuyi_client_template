...
import { saveSmartParsing, deleteSmartParsing, batchDeleteSmartParsing, updateSmartParsing, listSmartParsing } from '@/api/smart-parsing'
        ...
        proxyConfig: {
          ...
          ajax: {
            ...
            query: ({ page, sort, filters }) => {
              ...
              return listSmartParsing(result)
            }
          }
        },
        columns: [
    ...
    handleBatchDelete() {
      ...
      if (!(typeof selectRecords === 'undefined' || selectRecords === null || selectRecords === '' || selectRecords.length === 0)) {
        this.$confirm('永久删除记录吗, 是否继续?', '提示', {
          ...
          batchDeleteSmartParsing(batchDeleteData)
            .then(response => {
