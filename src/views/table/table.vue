...
export default {
  ...
  methods: {
    getMinHeight() {
      this.mainHeight = window.innerHeight - 210 ;
    },
    initComponent() {
      ...
      lines.area().adjust("stack").position("year*value").color("country");
      lines.line().adjust("stack").position("year*value").color("country");
