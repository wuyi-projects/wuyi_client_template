...
import { listCustomerBasicInfoForRegionalManage, saveCustomerBasicInfo, deleteCustomerBasicInfo, batchDeleteCustomerBasicInfo, updateCustomerBasicInfo } from '@/api/customer-basic-info'
        ...
        proxyConfig: {
          ...
          ajax: {
            ...
            query: ({ page, sort, filters }) => {
              ...
              return listCustomerBasicInfoForRegionalManage(result)
            }
          }
        },
        columns: [
