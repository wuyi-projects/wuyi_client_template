    ...
    <el-card class="box-card" shadow="never">
      ...
      <vxe-grid ref="dataGrid" class="custom-table-scrollbar" v-bind="gridOptions">
        ...
        <template v-slot:buttons>
          ...
          <el-radio-group v-model="tabPosition" style="margin-left:10px;margin-bottom: 3px;">
...
import { listRolePermission } from '@/api/permission'
        ...
        proxyConfig: {
          ...
          ajax: {
            ...
            query: ({ page, sort, filters }) => {
              ...
              return listRolePermission(result)
            }
          }
        },
        columns: [
