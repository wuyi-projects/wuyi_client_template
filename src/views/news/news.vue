        ...
        <template v-slot:operate="{ row }">
          ...
          <el-dropdown @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item
                :command="beforeHandleCommand('handleUpdate', row)"
              >
                修改
              </el-dropdown-item>
              <el-dropdown-item
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      this.$router.push('/news/news-edit')
      /**
    ...
    handleBatchDelete() {
      ...
      if (!(typeof selectRecords === 'undefined' || selectRecords === null || selectRecords === '' || selectRecords.length === 0)) {
        this.$confirm('永久删除记录吗, 是否继续?', '提示', {
          ...
          batchDeleteNews(batchDeleteData)
            .then(response => {
